...
//大模型机器人 流程 按钮消息 ViewPager
public class RobotAiAgentButtonViewPager extends ViewPager {
    private SobotRobotAiAgentButtonPageAdater adapter;
    private ZhiChiMessageBase message;

    public RobotAiAgentButtonViewPager(Context context) {
        super(context);
    }

    public RobotAiAgentButtonViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setTemplatePageAdater(SobotRobotAiAgentButtonPageAdater adapter, ZhiChiMessageBase message) {
